...
# Install full desktop version (includes rviz2, demo nodes, etc.)
mamba install -c conda-forge -c robostack-staging ros-humble-desktop-full

# Install build tools (for compiling packages)
mamba install -c conda-forge -c robostack-staging compilers cmake pkg-config make ninja colcon-common-extensions catkin_tools rosdep
